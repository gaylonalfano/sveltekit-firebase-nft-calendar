<script lang="ts">
	...
	// $: console.log('showAddEventModal?', $showAddEventModal);
	...
	function handleSubmit() {
		...
		if (formIsValid) {
			...
			showAddEventModal.update(($showAddEventModal) => ($showAddEventModal = !$showAddEventModal));
			// showAddEventModal.set(false);
		}
	}
</script>
